...
class Category
{
    ...
    public static $checks = array(
        ...
        "CleanCode/DuplicatedArrayKey" => [self::CLARITY, 200000],
        "CleanCode/ErrorControlOperator" => [self::BUG_RISK, 200000],
        "CleanCode/MissingImport" => [self::CLARITY, 200000],
        "CleanCode/UndefinedVariable" => [self::CLARITY, 200000],
        ...
        "Design/EmptyCatchBlock" => [self::BUG_RISK, 100000],
        ...
        "Naming/ShortClassName" => [self::STYLE, 1000000],
